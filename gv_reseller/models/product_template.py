...
class gv_product_template(models.Model):
	...
	dependencies = fields.Many2many(comodel_name='product.template',
							...
							column1='id',
							column2='dependent_id', 
							help='Other modules that this module depends on. This means that selecting the current module will cause the modules in this field to be selected as well.',
							domain="['|', ('type', '=', 'misc'), ('type', '=', 'module'), ('id', '!=', id)]"
							)
	...
	other_services = fields.Many2many(comodel_name='product.template',
 							relation='module_other_services',
 							column1='module_id',
 							column2='other_service_id', 
 							help='Other services that should be made available when this module is selected',
 							domain="[('type', '=', 'other')]")
